...
class Settings:
    ...
    image_model_provider: str = os.getenv("IMAGE_MODEL_PROVIDER", "ark")
    image_model_name: str = os.getenv("IMAGE_MODEL_NAME", "Doubao-Seedream-5.0-lite")
    has_image_model_id_override: bool = "IMAGE_MODEL_ID" in os.environ
    image_model_id: str = os.getenv(
        "IMAGE_MODEL_ID", os.getenv("IMAGE_MODEL_NAME", "Doubao-Seedream-5.0-lite")
    )
    ...
    image_size: str = os.getenv("IMAGE_SIZE", "1728x2304")
